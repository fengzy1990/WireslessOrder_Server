					...
					<td align="left" valign="top">
						...
						<TABLE width="100%" class="position">
							<TR>
								...
								<TD align="right">
									<a
										href="menu.do?method=list&pageSize=<%=pageSize%>&pageNo=<%=pageNo%>">返回菜单列表页面</a>
								</TD>
								<TD width="20"></TD>
							</TR>
						</TABLE>
						<form name="form1" action="upload.do?method=insert" ENCTYPE="multipart/form-data" method="post"
							onsubmit="return validMenuAdd(this);">
							...
							<TABLE border="0" width="100%">
								...
								<TR>
									...
									<TD>
										<select name="menutype">
											...
											%>
												<option value="<%=mtb.getTypeid() %>"> <%=mtb.getTypename() %></option>
											<%
												} 
								...
								<TR>
									...
									<TD>
										<input type="text" name="price" maxlength="20" value="">
									</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									...
									<TD>
										<input type="text" name="remark" maxlength="20" value="">
									</TD>
								</TR>
